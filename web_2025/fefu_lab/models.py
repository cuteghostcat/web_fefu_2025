...
class Instructor(models.Model):
    ...
    degree = models.CharField(max_length=100, verbose_name='Степень', blank=True)
...
class Course(models.Model):
    ...
    instructor = models.ForeignKey(Instructor, on_delete=models.SET_NULL, null=True, verbose_name='Преподаватель')
...
class Enrollment(models.Model):
    ...
    class Meta:
        ...
        unique_together = ['student', 'course']  # Не позволять дубликаты
